...
alias build='zig build build-all --error-style minimal_clear --summary all'
...
# Attach to or start the gameEngine Zellij session
function zj() {
    zellij attach gameEngine 2>/dev/null || zellij --session gameEngine
}
