...
pub const NIGHT_BLACK = Color.initRgba(13, 13, 15, 255); // Softer than pure black
pub const NIGHT_GRAY = Color.initRgba(28, 28, 32, 255); // Background/Surface level
pub const NIGHT_SLATE = Color.initRgba(45, 45, 54, 255); // Component/Button level
pub const NIGHT_TEXT = Color.initRgba(169, 176, 194, 255); // Soft blue-ish white for text
...
pub const TOXIC_GREEN = Color.initRgba(0, 68, 27, 255); // Dark, glowing green
pub const CRIMSON_DUSK = Color.initRgba(100, 10, 10, 255); // Dark red for warnings
...
pub const SLATE_900 = Color.initRgba(15, 17, 26, 255); // Deep Background
pub const SLATE_700 = Color.initRgba(31, 35, 51, 255); // Panels
pub const SLATE_500 = Color.initRgba(71, 85, 122, 255); // Mid-tones
pub const SLATE_300 = Color.initRgba(148, 163, 204, 255); // Borders
pub const SLATE_100 = Color.initRgba(219, 227, 248, 255); // UI Text

// 2. THE "DESERT & DUST" FAMILY (Warm/Earthy/Organic)
// Great for testing terrain and "warm" lighting
pub const DUST_DARK = Color.initRgba(66, 40, 31, 255); // Mud/Deep Earth
pub const DUST_MID = Color.initRgba(163, 103, 75, 255); // Dirt/Brick
pub const DUST_LIGHT = Color.initRgba(224, 170, 117, 255); // Sand/Skin highlight
pub const DUST_GOLD = Color.initRgba(245, 203, 92, 255); // Harvest/Warm light

// 3. THE "CYBER" FAMILY (High-Saturation/Neon)
// Use these for "Selection" states or FX
pub const CYBER_GRAPE = Color.initRgba(111, 22, 235, 255); // Intense Purple
pub const CYBER_MELON = Color.initRgba(0, 255, 159, 255); // Bright Teal/Green
pub const CYBER_BANANA = Color.initRgba(255, 240, 31, 255); // High-viz yellow
pub const CYBER_GLITCH = Color.initRgba(255, 0, 110, 255); // Hot Pink
...
pub const BERRY_SHADOW = Color.initRgba(74, 13, 56, 255); // Shifted toward Purple
pub const BERRY_BASE = Color.initRgba(190, 33, 55, 255);
pub const BERRY_LUME = Color.initRgba(255, 138, 148, 255); // Shifted toward Pink

pub const FOREST_SHADOW = Color.initRgba(13, 43, 46, 255); // Shifted toward Teal
pub const FOREST_BASE = Color.initRgba(38, 92, 66, 255);
pub const FOREST_LUME = Color.initRgba(163, 206, 39, 255); // Shifted toward Yellow
...
pub const SKIN_DEEP = Color.initRgba(115, 62, 57, 255); // Deep shadow
pub const SKIN_WARM = Color.initRgba(191, 121, 88, 255); // Mid-tone
pub const SKIN_PALE = Color.initRgba(230, 190, 181, 255); // Highlight
pub const BONE_IVORY = Color.initRgba(235, 229, 206, 255); // Skeleton/Ancient teeth

// 3. THE "POISON & ACID" FAMILY (Vibrant Hazards)
// High-visibility greens and yellows for gameplay hazards
pub const ACID_CORE = Color.initRgba(204, 255, 0, 255); // Glowing center
pub const ACID_STING = Color.initRgba(127, 255, 0, 255); // Mid-glow
pub const ACID_MUD = Color.initRgba(45, 89, 0, 255); // Liquid base
...
pub const BARK_SHADOW = Color.initRgba(44, 33, 55, 255); // Purple-ish shadow (Hue Shift!)
...
pub const DEBUG_MAGENTA = Color.initRgba(255, 0, 255, 255); // Classic "missing texture"
pub const HITBOX_RED = Color.initRgba(255, 0, 0, 128); // Semi-transparent red
pub const TRIGGER_BLUE = Color.initRgba(0, 0, 255, 128); // Semi-transparent blue
...
pub const SHIRONERI = Color.initRgba(243, 243, 242, 255); // Unbleached silk
pub const GOFUN = Color.initRgba(255, 255, 252, 255); // Chalk white
pub const SHIRONEZUMI = Color.initRgba(185, 183, 178, 255); // White-gray
pub const GINSHU = Color.initRgba(188, 45, 41, 255); // Vermillion
pub const BENIAKA = Color.initRgba(203, 76, 77, 255); // Red
pub const SHINSHU = Color.initRgba(139, 36, 31, 255); // Deep red
pub const ENJI = Color.initRgba(158, 43, 43, 255); // Rouge
pub const SAKURA = Color.initRgba(254, 223, 225, 255); // Cherry blossom
pub const MOMO = Color.initRgba(244, 149, 155, 255); // Peach
pub const USUBENI = Color.initRgba(242, 102, 108, 255); // Light crimson
pub const SOHI = Color.initRgba(227, 92, 56, 255); // Scarlet
pub const HIWA = Color.initRgba(141, 178, 85, 255); // Yellowish green
pub const MOEGI = Color.initRgba(144, 181, 114, 255); // Fresh onion
pub const MATCHA = Color.initRgba(194, 193, 152, 255); // Matcha green
pub const ROKUSHO = Color.initRgba(71, 133, 133, 255); // Patina
pub const WASURENAGUSA = Color.initRgba(137, 195, 235, 255); // Forget-me-not
pub const HANADA = Color.initRgba(4, 79, 103, 255); // Indigo
pub const RURI = Color.initRgba(31, 71, 136, 255); // Lapis lazuli
pub const KONJOU = Color.initRgba(0, 49, 113, 255); // Deep blue
pub const AI = Color.initRgba(38, 67, 72, 255); // Indigo plant
pub const SUMIRE = Color.initRgba(91, 50, 86, 255); // Violet
pub const FUJI = Color.initRgba(187, 169, 219, 255); // Wisteria
pub const MURASAKI = Color.initRgba(79, 40, 75, 255); // Purple
pub const KINCHA = Color.initRgba(198, 132, 61, 255); // Golden brown
pub const KITSUNE = Color.initRgba(152, 86, 41, 255); // Fox
pub const KURI = Color.initRgba(85, 46, 40, 255); // Chestnut
pub const TONOCHA = Color.initRgba(152, 116, 86, 255); // Distant brown
pub const NEZUMI = Color.initRgba(109, 109, 109, 255); // Mouse gray
pub const SUMI = Color.initRgba(39, 34, 31, 255); // Ink
