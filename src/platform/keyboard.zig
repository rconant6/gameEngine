...
pub const Keyboard = struct {
    ...
    keysPressed: [MAX_KEYS]bool = .{false} ** MAX_KEYS,
    keysJustPressed: [MAX_KEYS]bool = .{false} ** MAX_KEYS,
    keysJustReleased: [MAX_KEYS]bool = .{false} ** MAX_KEYS,

    pub fn isKeyPressed(self: *const Keyboard, key: KeyCode) bool {
        return self.keysPressed[@intFromEnum(key)];
    }
    pub fn wasKeyJustPressed(self: *const Keyboard, key: KeyCode) bool {
        return self.keysJustPressed[@intFromEnum(key)];
    }
    pub fn wasKeyJustReleased(self: *const Keyboard, key: KeyCode) bool {
        return self.keysJustReleased[@intFromEnum(key)];
    }
    pub fn updateKeyPress(
        pressed: *bool,
        justPressed: *bool,
        justReleased: *bool,
    ) void {
    ...
    pub fn update(self: *Keyboard) void {
        @memset(&self.keysJustPressed, false);
        @memset(&self.keysJustReleased, false);
    }

    // TODO: Probably can provide this depending on system support
    // pub fn isModifierPressed(self: *const Keyboard, modKey: ModifierKey) bool {
    //     return switch (modKey) {
    //         .Shift => return self.modifiers.shift == 1,
    //         .Control => return self.modifiers.control == 1,
    //         .Option => return self.modifiers.option == 1,
    //         .Command => return self.modifiers.command == 1,
    //     };
    // }
    // pub fn isShiftPressed(self: *const Keyboard) bool {
    //     return self.modifiers.shift == 1;
    // }
    // pub fn isCtrlPressed(self: *const Keyboard) bool {
    //     return self.modifiers.control == 1;
    // }
    // pub fn isOptionPressed(self: *const Keyboard) bool {
    //     return self.modifiers.option == 1;
    // }
    // pub fn isCommandPressed(self: *const Keyboard) bool {
    //     return self.modifiers.command == 1;
    // }
};
...
fn mapToGameKeyCode(osKeyCode: u16) KeyCode {
